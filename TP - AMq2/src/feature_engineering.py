...
class FeatureEngineeringPipeline(object):
    ...
    def data_transformation(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        df_transformed['Outlet_Location_Type'] = df_transformed['Outlet_Location_Type'].replace({'Tier 1': 2, 'Tier 2': 1, 'Tier 3': 0}) # Estas categorias se ordenaron asumiendo la categoria 2 como más lejos
        ...
        df_transformed = df_transformed.drop(columns=['Item_Identifier', 'Outlet_Identifier', 'Set'])
